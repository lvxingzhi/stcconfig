...
public class ConfigController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/getConfigInfo", produces = "application/json;charset=utf-8")
    public Map<String, Object> getConfigInfo(@RequestBody JSONObject json) {
        RestTemplate restTemplate = new RestTemplate();
        String response = restTemplate.postForObject(ServerUrlConstant.BASE_URL + ServerUrlConstant.SERVER_CONFIG_INFO, json, String.class);
        Map<String, Object> map = new HashMap<>();
        map.put("code", 0);
        map.put("msg", "成功");
        map.put("count", 1);
    ...
    public Map<String, Object> update(@RequestBody JSONObject json) {
        RestTemplate restTemplate = new RestTemplate();
        restTemplate.postForObject(ServerUrlConstant.BASE_URL + ServerUrlConstant.SERVER_UPDATE_CONFIG, json, String.class);
        Map<String, Object> map = new HashMap<>();
        map.put("code", 0);
        map.put("msg", "成功");
        return map;
    ...
    public Map<String, Object> delete(@RequestBody JSONObject json) {
        RestTemplate restTemplate = new RestTemplate();
        restTemplate.postForObject(ServerUrlConstant.BASE_URL + ServerUrlConstant.SERVER_DELETE_CONFIG, json, String.class);
        Map<String, Object> map = new HashMap<>();
        map.put("code", 0);
        map.put("msg", "成功");
        return map;
